 ...
 * this class when your require custom CRUD logic. <p/> <p> To register this
 * class in your Spring context file, use the following XML.
 * 
 * <pre> &lt;bean id="fooDao"
 * class="war.webapp.dao.hibernate.GenericDaoHibernate"&gt; &lt;constructor-arg
 * value="war.webapp.model.Foo"/&gt; &lt;property name="sessionFactory"
 * ref="sessionFactory"/&gt; &lt;/bean&gt; </pre>
 * 
